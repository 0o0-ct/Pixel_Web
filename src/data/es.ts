  ...
  home: {
    ...
    services: {
      ...
      items: [
        ...
        {
          icon: 'cart',
          title: 'Tiendas y Ventas en Línea',
          desc: 'Plataformas de comercio electrónico rápidas y seguras para vender productos o cobrar servicios por internet.',
          href: '/servicios#store',
        },
        {
          icon: 'building',
          title: 'Webs Corporativas y Marcas',
          desc: 'Una presencia profesional que genera confianza en tus clientes y refleja los valores de tu empresa desde el primer clic.',
  ...
  services: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: 'Plataformas de comercio electrónico rápidas y seguras para vender productos o cobrar servicios por internet.',
        features: [
          'Gestión digital para inventarios, productos y servicios.',
          'Plataforma de pagos 100% segura para tranquilidad de tus clientes.',
          'Panel de control intuitivo diseñado para la administración de tu negocio.',
          'Generación de comprobantes y notificaciones automáticas de compra.',
        ],
        anchor: 'store',
        cta: { label: 'Solicitar presupuesto', href: '/contacto' },
      },
      {
        ...
        desc: 'Una presencia profesional que genera confianza en tus clientes y refleja los valores de tu empresa desde el primer clic.',
        features: [
          'Estructura clara para presentar tus servicios, equipo y ventajas competitivas.',
          'Módulo de noticias, blog y novedades para tu comunidad de clientes.',
          'Opción bilingüe ideal para marcas con proyección global.',
          'Visualización perfecta para que tus clientes naveguen desde sus celulares.',
        ],
        anchor: 'corporate',
        cta: { label: 'Solicitar presupuesto', href: '/contacto' },
      },
      {
        ...
        features: [
          ...
          'Integración destacada con Google Maps para facilitar que te visiten.',
          'Reportes de analítica para saber cuántas personas visitan tu página.',
        ],
        anchor: 'seo',
        cta: { label: 'Solicitar presupuesto', href: '/contacto' },
      },
      ...
      plans: [
        {
          ...
          featured: false,
          features: [
            '1 a 3 páginas optimizadas',
            'Información institucional y admisiones',
            'Formulario de contacto y consultas',
            'Diseño responsive adaptado a móviles',
            'Ubicación Google Maps + SEO básico',
            'Publicación y dominio listo',
          ],
          cta: { label: 'Empezar proyecto', href: '/contacto' },
        },
        {
          name: 'Profesional',
          ...
          featured: true,
          features: [
            'Hasta 8 páginas corporativas o Blog',
            'Catálogo de servicios y portafolio',
            'Diseño premium a medida + Multilingüe ES/EN',
            'Integración con WhatsApp y CRM',
            'SEO avanzado + Google Analytics',
            'Panel de edición fácil + 3 meses de soporte',
          ],
        ...
        },
        {
          ...
          featured: false,
          features: [
            'Catálogo ilimitado de productos y stock',
            'Pasarelas de pago seguras (Tarjetas/Transferencia)',
            'Carrito de compras y gestión de envíos',
            'SEO optimizado para productos',
            'Capacitación para gestionar la tienda',
            '3 meses de soporte técnico incluidos',
          ],
