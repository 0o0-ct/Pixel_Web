...
export const content: SiteContent = {
  ...
  home: {
    ...
    services: {
      eyebrow: 'Servicio',
      title: 'La presencia digital que tu centro educativo necesita para destacar',
      lead: 'Soluciones completas, transparentes y a medida: elegimos la tecnología por rendimiento, no por moda.',
      items: [
        {
          icon: 'zap',
          title: 'Campañas de Inscripción',
          desc: 'Páginas de alta conversión diseñadas específicamente para periodos de matrícula y captación de nuevos alumnos.',
          href: '/servicios#landing',
        },
        {
          icon: 'cart',
          title: 'Portales y Pagos en Línea',
          desc: 'Plataformas seguras para facilitar el pago de colegiaturas, venta de uniformes o integración con aulas virtuales.',
          href: '/servicios#store',
        },
        {
          icon: 'building',
          title: 'Webs Institucionales',
          desc: 'Una presencia profesional que genera confianza en los padres de familia y refleja los valores de tu institución desde el primer clic.',
          href: '/servicios#corporate',
        },
        {
          icon: 'trending',
          title: 'SEO Local y Visibilidad',
          desc: 'Optimización para que las familias de tu zona encuentren tu centro educativo rápidamente en los motores de búsqueda.',
          href: '/servicios#seo',
        },
      ],
    },
    ...
    cta: {
      title: 'Moderniza la imagen de tu centro educativo de forma ágil, segura y sin complicaciones',
  ...
  services: {
    ...
    items: [
      {
        ...
        desc: 'Páginas de alta conversión diseñadas específicamente para periodos de matrícula y captación de nuevos alumnos.',
        features: [
          'Diseño alineado a la identidad y valores de tu colegio.',
          'Textos enfocados en resaltar tu propuesta educativa para atraer familias.',
          'Navegación veloz para evitar que los padres abandonen el sitio.',
          'Formularios de admisión y agendamiento de recorridos integrados.',
        ],
        anchor: 'landing',
      ...
      },
      {
        ...
        desc: 'Plataformas seguras para facilitar el pago de colegiaturas, venta de uniformes o integración con aulas virtuales.',
        features: [
          'Gestión digital para pago de colegiaturas, uniformes y actividades.',
          'Plataforma de pagos 100% segura para tranquilidad de los padres.',
          'Panel de control intuitivo diseñado para el área de administración.',
          'Generación de comprobantes y notificaciones automáticas de pago.',
        ],
        anchor: 'store',
        cta: { label: 'Solicitar presupuesto', href: '/contacto' },
      },
      {
        ...
        desc: 'Una presencia profesional que genera confianza en los padres de familia y refleja los valores de tu institución desde el primer clic.',
        features: [
          'Estructura clara para presentar niveles académicos y currículo.',
          'Módulo de noticias, circulares y calendario para la comunidad.',
          'Opción bilingüe ideal para colegios con enfoque internacional.',
          'Visualización perfecta para que las familias naveguen desde sus celulares.',
        ],
        anchor: 'corporate',
        cta: { label: 'Solicitar presupuesto', href: '/contacto' },
      },
      {
        ...
        desc: 'Optimización para que las familias de tu zona encuentren tu centro educativo rápidamente en los motores de búsqueda.',
        features: [
          'Estrategia local para que tu colegio sea la primera opción en tu zona.',
          'Posicionamiento orgánico para destacar frente a otras instituciones.',
          'Integración destacada con Google Maps para facilitar la ubicación.',
          'Reportes de analítica para saber cuántas familias visitan la página.',
        ],
        anchor: 'seo',
        cta: { label: 'Solicitar presupuesto', href: '/contacto' },
      },
    ...
    cta: {
      title: '¿Listo para modernizar tu centro educativo?',
