      ...
      plans: [
        {
          ...
          featured: false,
          features: [
            '1 to 3 optimized pages',
            'Institutional info & admissions section',
            'Contact & inquiry form',
            'Mobile-responsive design',
            'Google Maps + Basic SEO setup',
            'Live publication & custom domain ready',
          ],
        ...
        },
        {
          ...
          featured: true,
          features: [
            'Up to 8 corporate pages or Blog',
            'Services catalog & portfolio showcase',
            'Premium custom design + Multilingual ES/EN',
            'WhatsApp & CRM integration',
            'Advanced SEO + Google Analytics',
            'Easy admin panel + 3 months of support',
          ],
        ...
        },
        {
          ...
          featured: false,
          features: [
            'Unlimited product catalog & inventory',
            'Secure payment gateways (Cards/Bank)',
            'Shopping cart & shipping calculation',
            'Optimized product SEO',
